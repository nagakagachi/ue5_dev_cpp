...
public:
	...
	const TArray<naga::gpgpu::GrassEntityAppendInfo>* GetCurrentFrameEmissionBuffer(bool is_render_thread = false) const
	{
...
private:
	...
	// エミッタ用
	TArray<naga::gpgpu::GrassEntityAppendInfo>	emission_buffer_[2];
};
