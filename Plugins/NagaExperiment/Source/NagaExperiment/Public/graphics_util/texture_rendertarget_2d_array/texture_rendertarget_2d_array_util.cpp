...
#include "texture_rendertarget_2d_array_util.h"

#include "RenderGraphUtils.h"
#include "Engine/TextureRenderTarget2DArray.h"
#include "Kismet/KismetRenderingLibrary.h"

UTextureRenderTarget2dArrayUtilBPLibrary::UTextureRenderTarget2dArrayUtilBPLibrary(const FObjectInitializer& ObjectInitializer)
...
// ---------------------------------------------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------------------
void UTextureRenderTarget2dArrayUtilBPLibrary::DrawMaterialToRenderTarget2dArraySlice(UObject* WorldContextObject, UMaterialInterface* Material, UTextureRenderTarget2DArray* TextureRt2dArray, int SliceIndex)
{
